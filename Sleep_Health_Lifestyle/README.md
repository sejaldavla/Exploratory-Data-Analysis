## This project uses a dataset containing sleep, health, and lifestyle factors to determine sleep disorder classification using k-nearest neighbor(kNN) supervised machine learning algorithm.
